// COMMON COUNTRY LIST - name, ISO2 code, dial code (country calling code)
// Isi ek file ko frontend (Sign in / Sign up dropdown) aur backend
// (validators) dono jagah copy/import karo - "single source of truth"
// rahegi, kahin bhi list alag-alag nahi honi chahiye.
//
// Flag emoji chahiye ho toh niche diya getFlagEmoji() function use karo,
// isse alag se flag images maintain nahi karni padengi.
...
// ISO2 code se flag emoji bana deta hai (koi image/asset maintain nahi karni padti)
// getFlagEmoji("IN") -> "🇮🇳"
...
// dial code se country dhoondhne k liye (validation me kaam aayega)
function findByDialCode(dialCode) {
    return COUNTRIES.find((c) => c.dialCode === dialCode) || null;
}

module.exports = { COUNTRIES, getFlagEmoji, findByDialCode };
// frontend (ES modules) me is line ko use karna, upar wali module.exports hata dena:
// export { COUNTRIES, getFlagEmoji, findByDialCode };